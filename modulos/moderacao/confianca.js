...
// Poda periódica: entradas cujo último sinal E último aviso já saíram das
// janelas não servem para nada — sem isto, o Map só crescia (um registro
// por par servidor:usuário que já disparou sinal, para sempre).
setInterval(() => {
