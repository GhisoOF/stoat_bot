...
export function construirDetalhes(P) {
  return {
    ...
    reactionrole: {
      ...
      desc: "Cargos por reação: `add <idMensagem> <emoji> <idCargo>` faz o bot reagir na mensagem e quem clicar ganha o cargo. `remove <idMensagem>` limpa; `list` mostra os vínculos. Alias: `${P}rr`.",
      perm: "ManageRole", ex: `${P}reactionrole add 01ABC... 🎮 01XYZ...`,
    },
    limpar: {
