  ...
  return {
    ...
    proteger: {
      ...
      linhas: [
        ...
        `\`${P}automod whitelist\` · \`${P}automod blocklist\` — convites permitidos · domínios proibidos`,
        ...
        `\`${P}warn lista [@pessoa]\` · \`${P}warn limpar @pessoa\` — ver e zerar avisos`,
    ...
    personalizar: {
      ...
      linhas: [
        ...
        `\`${P}ticket abrir\` — canal privado com a staff; ao fechar, a conversa é arquivada e o canal some`,
        "",
        "**O próprio bot**",
    ...
    diversao: {
      ...
      linhas: [
        ...
        "",
        "**Voz**",
        `\`${P}entrar\` — dentro da call: ela entra e lê tudo que for escrito ali (\`${P}sair\` desfaz)`,
        `\`${P}tts <texto>\` — ou só uma frase específica`,
        `\`${P}musica <link ou nome>\` — música na call (YouTube, SoundCloud, Spotify) com fila, skip e volume — e ela abaixa sozinha quando o TTS fala`,
        "",
    ...
    diagnostico: {
      ...
      linhas: [
        ...
        `\`${P}automod status\` · \`${P}automod sentinela\` · \`${P}automod punicao\` — estado da proteção`,
  ...
  return {
    ...
    proteger: {
      ...
      linhas: [
        ...
        `\`${P}automod whitelist\` · \`${P}automod blocklist\` — allowed invites · forbidden domains`,
        ...
        `\`${P}warn lista [@user]\` · \`${P}warn limpar @user\` — see and clear warnings`,
    ...
    personalizar: {
      ...
      linhas: [
        ...
        `\`${P}ticket abrir\` — private channel with staff; on close the conversation is archived and the channel disappears`,
        "",
        "**The bot itself**",
    ...
    diversao: {
      ...
      linhas: [
        ...
        "",
        "**Voice**",
        `\`${P}entrar\` — inside the call: she joins and reads everything written there (\`${P}sair\` undoes it)`,
        `\`${P}tts <text>\` — or just one specific line`,
        `\`${P}musica <link or name>\` — music in the call (YouTube, SoundCloud, Spotify) with queue, skip and volume — it auto-ducks while TTS speaks`,
        "",
    ...
    diagnostico: {
      ...
      linhas: [
        ...
        `\`${P}automod status\` · \`${P}automod sentinela\` · \`${P}automod punicao\` — protection state`,
