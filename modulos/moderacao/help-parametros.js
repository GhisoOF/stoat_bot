...
function parametrosPT(P) {
  ...
  return {
    ...
    tts: [
      ...
      { nome: "entrar", desc: "⭐ **o único comando que importa**: dentro da call, ela entra e passa a falar tudo que for escrito ali. Liga o sistema, escolhe a call e a leitura sozinha" },
...
function parametrosEN(P) {
  ...
  return {
    ...
    tts: [
      ...
      { nome: "entrar", desc: "⭐ **the only command that matters**: inside the call, she joins and starts speaking everything written there. Turns the system on, picks the call and the reading by herself" },
