  ...
  if (lang === "en") return [
    ...
    { title: "🎮 Getting started — XP and RPG",
      description: [
        ...
        `**Clock:** \`${P}fuso add London\` · **News:** \`${P}rss add <url>\` · **Voice:** \`${P}tts entrar\` inside the call — she joins and reads the chat`,
        "",
  ...
  return [
    ...
    { title: "🎮 Por onde começar — XP e RPG",
      description: [
        ...
        `**Relógio:** \`${P}fuso add Lisboa\` · **Notícias:** \`${P}rss add <url>\` · **Voz:** \`${P}tts entrar\` dentro da call — ela entra e lê o chat`,
        "",
