  ...
  return {
    ...
    rpg: {
      ...
      corpo: [
        ...
        "",
        "**Missões**",
        `\`${P}game missao\` — lista o que dá para fazer, com sua chance em cada uma`,
        `\`${P}game missao <nome>\` — parte`,
        "",
        "🏪 **Mercado** — sem risco de cair, paga pouco e não escala: é a rede de",
        "segurança do começo, e deixa de compensar sozinha conforme você sobe.",
        "🟢🟡🔴 **Dungeon** — três dificuldades, com risco real e loot de verdade.",
        "",
        ...
        `\`${P}game catalogo\` — resumo do que existe no jogo`,
        `\`${P}game catalogo lendario\` — a lista completa de uma raridade (ou slot)`,
        "",
        ...
        "",
        "_Followers, party e economia chegam nas próximas etapas._",
      ],
    },
