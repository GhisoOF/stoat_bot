  ...
  if (lang === "en") return {
    ...
    moderacao: {
      ...
      corpo: [
        ...
        "",
        `**4. If you use \`acumular\`:** \`${P}punicao escada\``,
        ...
        `Change it with \`${P}punicao escada aviso,10m,2h,ban\`. Needs a silence role (\`${P}cargomudo\`).`,
        `**5. If you use \`confirmar\`:** you need a silence role → \`${P}cargomudo\` creates one ready to go.`,
        "",
        `**Sentinel** (\`${P}sentinela\`, formerly \`scam\`): the only module that **judges** instead of measuring —`,
        ...
        `\`${P}sentinela on\` · \`${P}sentinela sensitivity <baixa|media|alta>\` · \`${P}sentinela antiguidade on|off\``,
  ...
  return {
    ...
    moderacao: {
      ...
      corpo: [
        ...
        "• `banir` — bane na hora",
        "",
        `**4. Se usar \`acumular\`:** \`${P}punicao escada\``,
        ...
        `Mude com \`${P}punicao escada aviso,10m,2h,ban\`. Precisa de cargo de silêncio (\`${P}cargomudo\`).`,
        `**5. Se usar \`confirmar\`:** precisa de um cargo de silêncio → \`${P}cargomudo\` cria um pronto.`,
        "",
        `**Sentinela** (\`${P}sentinela\`, antigo \`scam\`): o único módulo que **julga** em vez de medir —`,
