  ...
  if (lang === "en") return {
    ...
    aventura: {
      ...
      corpo: [
        ...
        `Your sheet (\`${P}game\`) lists all six, empty ones included.`,
        "The commons (♾️) are always available — nobody goes without equipment.",
        "",
        "**Magic**",
        `\`${P}game magias\` — the grimoire · \`${P}game aprender <name>\``,
        "Spells cost **Mana** and enter from the strongest down, while it lasts.",
  ...
  return {
    ...
    aventura: {
      ...
      corpo: [
        ...
        `Sua ficha (\`${P}game\`) lista os seis, inclusive os vazios.`,
        "Os comuns (♾️) estão sempre disponíveis — ninguém fica sem equipamento.",
        "",
        "**Magia**",
        `\`${P}game magias\` — o grimório · \`${P}game aprender <nome>\``,
        "Magias custam **Mana** e entram da mais forte para a mais fraca, enquanto ela durar.",
