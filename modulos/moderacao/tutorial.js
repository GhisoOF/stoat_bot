  ...
  return {
    ...
    cargos: {
      ...
      corpo: [
        ...
        `2. Ligue emoji → cargo: \`${P}reactionrole add <id-da-mensagem> 🎮 <id-do-cargo>\``,
        `3. Confira com \`${P}reactionrole list\``,
        "",
        `**Cargo de silêncio** (para \`${P}silence\` e o modo confirmar): \`${P}cargomudo\``,
...
const APELIDOS = {
  ...
  game: "xp", nivel: "xp", niveis: "xp", "níveis": "xp", level: "xp",
